...
class ImagePickerScrren extends StatefulWidget {
  const ImagePickerScrren({Key? key}) : super(key: key);

  @override
  _TestSingleImageScreenState createState() => _TestSingleImageScreenState();
}

class _TestSingleImageScreenState extends State<ImagePickerScrren> {
  File? _pickedFile;
